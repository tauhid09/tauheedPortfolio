...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    // Handle pointer events on the document level to ensure they work
    ...
    const handlePointerLeave = () => {
      // Reset pointer position when leaving the container
  ...
  // Remove the separate useEffect for pointer events since we're handling them in the main useEffect
