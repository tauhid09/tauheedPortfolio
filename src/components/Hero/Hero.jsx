...
export function Hero({ theme, colors, onScrollToSection }) {
  // Force dark theme styling since light mode is disabled
  const isDark = true;
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in">
            ...
            <div className="flex justify-center gap-6">
              <a target='_blank' href="https://github.com/tauhid09" className={`transition-colors ${isDark ? 'text-white hover:text-gray-500' : 'text-slate-900 hover:text-gray-700'
                }`}>
                <Github className="w-10 h-10" />
              </a>
              <a target='_blank' href="https://www.linkedin.com/in/mohd-tauheed-ansari/" className={`transition-colors ${isDark ? 'text-white hover:text-blue-600' : 'text-slate-900 hover:text-blue-700'
                }`}>
                <Linkedin className="w-10 h-10" />
              </a>
              <a href='mailto:mohdtauheedansari479@gmail.com' className={`transition-colors ${isDark ? 'text-white hover:text-red-600' : 'text-slate-900 hover:text-red-700'
                }`}>
